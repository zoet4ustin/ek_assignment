...
const STEPS = [
  ...
  { q: 'Q2', t: 'Creator Studio earns its price before asking for it', d: 'Four separate tools cost about ₹7,850 a month and four logins. One tool costs ₹599 with the links already tracked. She sees that comparison, then picks a door — start free, or see Pro. No card until the clone.' },
  { q: 'Q2', t: 'A homepage that keeps learning', d: 'Offers arrive as a swipe stack. Left means “not for me” and damps that category in the same model the collage seeded, so browsing keeps sharpening the profile instead of just consuming it.' },
